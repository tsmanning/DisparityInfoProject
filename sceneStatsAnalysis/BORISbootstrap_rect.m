...
realDatDir = '~/Documents/MATLAB/cooperLab/2-Modeling_Simulations/disparityMTModel/5-sceneStatsAnalysis/imgStats/';
datDir = '~/Documents/MATLAB/cooperLab/2-Modeling_Simulations/disparityMTModel/5-sceneStatsAnalysis/borisStats/';
            ...
            for ll = 1:5
                ...
                for ii = 1:100
                    ...
                    try
                        ...
                        missingRuns(missCnt).filename = ['dispHist',region{kk},'_',imRegion{ll},imgSet{jj},num2str(ii)];
                        missCnt = missCnt + 1;
...
if 1
    ...
    for ii = 1:2
        ...
        for jj = 1:5
            ...
            % Load real (non-bootstrapped) stats
            ...
            thisMT = load([datDir,'dispHist',region{4},'_',imRegion{jj},imgSet{ii}]);
            MTDat = thisMT.(['dispHistV1V2Rect',suff{jj}]);
